...
public class BookingJournal {
  ...
  @JoinColumn(name = "Emp_ID")
    ...
    public BookingJournal(Employee emp, Room room_id, LocalDate date_from, LocalDate date_to, double total_price) {
        this.emp = emp;
    ...
    public String toString() {
        return String.format("BookingJournal [id = '%d', user = '%d', room_id = '%d', date_from = '%s', date_to = '%s', total_price = '%8.2f']",
                id, emp.getId(), room_id.getId(), date_from, date_to, total_price);
    }
}